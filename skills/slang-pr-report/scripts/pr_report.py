...
# Bot-transparency disclaimer appended to the report.
BOT_DISCLAIMER = (
    "\n\n> <sub>\U0001f916 Generated by an automated Slang coworker — may be "
    "inaccurate. A human should verify.</sub>"
)
...
# fields, CI rollup, reviews, requested reviewers, assignees, merge-queue.
_PR_QUERY = """
...
def compute_stall(pr: PR, cfg: Config, prior: dict[str, Any], now: datetime,
    ...
    bot PR's promotion each register as movement, per source."""
